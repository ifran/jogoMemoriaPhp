<?php 
    ...
    DEFINE('DB_NAME'     , 'id17827657_memory');
    DEFINE('DB_USER'     , 'id17827657_andrei_ulbra');
    DEFINE('DB_PASSWORD' , 'a}>9$$\z>h(~@mO!');
    
    // Caminho para aplicacao
    DEFINE('GAME_HOST_LOCAL'      , $_SERVER['DOCUMENT_ROOT'] . '/');
    ...
    // Caminho para public
    DEFINE('GAME_HOST_PUBLIC'     , 'https://jogomemoriaulbra.000webhostapp.com/');
